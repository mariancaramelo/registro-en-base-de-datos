...
<html>
  ...
  <body>
    <h1>peces</h1>
   <form  method="post"  action="peces.php">
 ...
 try {
     $conexion = new PDO('mysql:host=localhost;dbname=foro-et20.','root', '');
      ...
      if(!empty($_POST)){
        ...
        $conexion->query("INSERT INTO `peces` (`id`, `nickname`, `comentario`, `fecha`) VALUES (NULL, '$nombre', '$comentario',  '$fecha');");
        ...
        $busca = $conexion->query("SELECT * FROM `peces`");
